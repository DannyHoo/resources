...
public class FileUploadController {
    ...
    public static void uploadWebContent() {
        //构造一个带指定Zone对象的配置类
        Configuration cfg = new Configuration(Zone.zone1());
        //...其他参数参考类注释
        String accessKey = "t12Htj_DOr4vaGnurfOpbSfZ5ZJG2Q_JjM1BxdTT";
        String secretKey = "v6UwgHtwd-tGUwBEDvr5MvGOrUf7LHY2SX-8zoi4";
        String bucket = "easysharing";
        String key = "bizhi/"+Generator.getRandomTimeStr() +".jpg";
        String remoteSrcUrl = "http://118.24.51.89/group1/M00/00/01/rBsABVs3sw-AfA9YAAg-hL8QFQo350.jpg";
        Auth auth = Auth.create(accessKey, secretKey);
